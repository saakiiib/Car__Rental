      ...
      <div class="col-md-8">
        ...
        <div class="card card-secondary">
          <div class="card-header">
            <h3 class="card-title" id="card-title">Add new customer</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <div class="ermsg"></div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a id="deleteBtn" rid="{{$data->id}}"><i class="fa fa-trash" style="color: red;font-size:16px;"></i></a>
                  </td>
                </tr>
                @endforeach
...
<script>
  $(document).ready(function() {
    ...
    var upurl = "{{URL::to('/admin/customer-update')}}";
    // console.log(url);
    ...
    function populateForm(data) {
      ...
      $("#addBtn").val('Update');
      $("#addBtn").html('Update');
      $("#card-title").html('Update this customer');
      $("#addThisFormContainer").show(300);
      $("#newBtn").hide(100);
    }
    ...
    function clearform() {
      ...
      $("#addBtn").val('Create');
      $("#card-title").html('Add new customer');
      $(".ermsg").html('');
    }
  });
</script>
